        ...
        <div className='w-full h-[80vh]'>
            ...
            <div className='p-20 my-48'>
                ...
                <div className='w-full h-full flex flex-col items-center justify-center gap-y-16'>
                    ...
                    <a href='/Pro-Ecommerce' className='w-96 h-16 content-center bg-[#DB4444] text-white text-xl rounded-md text-center'>Back to home page</a>
                </div>
            </div>
            <Footer />
        </div>
