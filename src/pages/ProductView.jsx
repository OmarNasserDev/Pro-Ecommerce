...
const ProductView = () => {
    ...
    // }
    // if (!dataToView.rating.rate) {
    //     setData({ load: Loading })
    // } else {
    //     setData(dataToView)
    // }
    ...
    return (
        <div className='w-full h-full px-48'>
            <div className='flex my-20 text-xl gap-x-5 text-gray-500 font-sans italic'>
                <h1>Account</h1>
                /
            ...
            <div className='w-full grid grid-cols-2 mb-48'>
                <div className='w-full grid grid-cols-12 mr-10'>
                    <div className='col-span-2 mr-5'>
                        <div className='h-48 mb-2 bg-slate-300 flex items-center justify-center'><img src={dataToView.image} alt="" className='w-28 h-44 object-contain' /></div>
                        <div className='h-48 mb-2 bg-slate-300 flex items-center justify-center'><img src={dataToView.image} alt="" className='w-28 h-44 object-contain' /></div>
                        <div className='h-48 mb-2 bg-slate-300 flex items-center justify-center'><img src={dataToView.image} alt="" className='w-28 h-44 object-contain' /></div>
                        <div className='h-48 mb-2 bg-slate-300 flex items-center justify-center'><img src={dataToView.image} alt="" className='w-28 h-44 object-contain' /></div>
                    </div>
                    <div className='col-span-8 bg-gray-200 p-16'><img src={dataToView.image} alt="" /></div>
                </div>
                <div className='w-full pr-64 flex flex-col items-start'>
                    <h1 className='text-3xl font-sans'>{dataToView.title}</h1>
                    ...
                    <div className='flex items-center gap-5 my-5'>
                        <div className='min-w-28 h-14 border-2 border-gray-300 flex items-center justify-center text-center'>
                            <button className='w-16 h-full border-r-2 border-gray-300 text-3xl hover:bg-[#DF4444] hover:text-white'>-</button>
                            <input type="text" value={1} className='text-center w-28 text-3xl font-sans' />
                            <button className='w-16 h-full border-l-2 border-gray-300 text-3xl hover:bg-[#DF4444] hover:text-white'>+</button>
                        </div>
                        <div>
                            <button className='w-52 h-16 text-white font-sans text-xl bg-[#DB4444] rounded-md'>Buy Now</button>
                        </div>
                        <div className='w-16 h-16 border-2 border-gray-400 flex items-center justify-center rounded-md'>
                            <button>
                                <FavoriteBorderIcon />
                            </button>
                        </div>
                    </div>
                    <div className='w-full  mr-96 border-2 border-gray-400 rounded-md'>
